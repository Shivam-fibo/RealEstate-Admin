  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setImagePreviews(propData.property.images?.map(img => img.url) || []);
        ...
        <div className="form-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <select
              ...
              value={property.furnishingStatus || 'Furnished'}
              onChange={handleChange}
              required
              className="border border-gray-300 p-2 rounded-md"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <label className="flex items-center gap-2 text-sm text-gray-700">
              <input
                type="checkbox"
                name="reraApproved"
                checked={property.reraApproved || false}
                onChange={handleChange}
              />
              RERA Approved
            </label>
            ...
            <select
              name="ownership"
              value={property.ownership || 'Freehold'}
              onChange={handleChange}
              required
              className="border border-gray-300 p-2 rounded-md"
            >
            ...
            <select
              ...
              value={property.completionStatus || 'Under-construction'}
              onChange={handleChange}
              required
              className="border border-gray-300 p-2 rounded-md"
            >
